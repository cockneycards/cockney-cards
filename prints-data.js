...
const PRINT_CATALOGUE = {
    ...
    "palace-eatsleep": {
        ...
        categories: ["all", "sports"],
        name: { label: "First Name", left: 294, top: 708, startSize: 100, minSize: 23, maxSize: 100, fontFamily: "Anton", fontWeight: "normal", color: "#c4132e", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 150, tiltAngle: 0, label: "Name", maxChars: 9,
            onlyForVariants: ["palace-boy", "palace-girl"], // no name field on the plain full/duo version — only these two personalised variants
            shadow: { color: "rgba(255,255,255)", blur: 1, offsetX: -7, offsetY: 7 } // bold, hard, dark drop shadow, offset left to match the footballer silhouette shading
        },
