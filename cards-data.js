...
const CARD_CATALOGUE = {
  ...
  "birthday-mfc-photo1": { title: "Lions Birthday", categories: ["sports", "football", "championship", "millwall"], preview: "v1785235108/birthday-mfc-photo1-preview_x5yj5l.png", full: "v1785235053/birthday-mfc-photo1_zv3ntf.png", name: { left: 883, top: 750, startSize: 70, minSize: 60, maxSize: 80, fontFamily: "Anton", fontWeight: "normal", color: "#0F214B", canChangeSize: true, canChangeColor: false, canMove: false, canRotate: false, isCurved: true, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 12 },
    photo: { left: 909.6, top: 331.3, width: 408.1, height: 385.4 } },
