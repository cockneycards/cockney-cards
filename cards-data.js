...
const CARD_CATALOGUE = {
  "11plus-boy": { title: "11 Plus Boy", categories: ["school-cards", "achievements"], preview: "11plus-boy-preview.png", full: "11plus-boy.png" },
  "11plus-girl": { title: "11 Plus Girl", categories: ["school-cards", "achievements"], preview: "11plus-girl-preview.png", full: "11plus-girl.png" },
  "11plus-kids": { title: "11 Plus Kids", categories: ["school-cards", "achievements"], preview: "11plus-kids-preview.png", full: "11plus-kids.png" },

  "birthday-80sbirthday": { title: "80s Retro Birthday", categories: ["all", "birthdays", "tv-movies"], preview: "80s-birthday-preview.png", full: "80s-birthday.png" },
  "birthday-90sbirthday": { title: "90s Retro Birthday", categories: ["all", "birthdays", "tv-movies"], preview: "90s-birthday-preview.png", full: "90s-birthday.png" },
  "birthday-artsy-girl": { title: "Artsy Girl", categories: ["all", "children", "birthdays"], preview: "artsy-girl-preview.png", full: "artsy-girl.png" },
  ...
  "birthday-sweetie": { title: "Sweet Tooth", categories: ["all", "birthdays"], preview: "birthday-sweetie-preview.png", full: "birthday-sweetie.png" },
  ...
  "birthday-horse-boy": { title: "Racing Fan", categories: ["all", "horseracing", "birthdays"], preview: "birthday-horse-boy-preview.png", full: "birthday-horse-boy.png" },
  ...
  "birthday-gymboy": { title: "Gym Bro", categories: ["all", "birthdays"], preview: "birthday-gymboy-preview.png", full: "birthday-gymboy.png" },
  ...
  "birthday-cake1": { title: "Anyone for Cake?", categories: ["all", "birthdays"], preview: "birthday-cake1-preview.png", full: "birthday-cake1.png" },
  "birthday-baking-girl": { title: "Baking Girls", categories: ["all", "birthdays"], preview: "birthday-baking-girl-preview.png", full: "birthday-baking.png" },
  ...
  "birthday-grandad-horseracingtv": { title: "Grandads Horse Racing", categories: ["grandad", "birthdays", "horseracing"], preview: "birthday-grandad-horseracingtv-preview.png", full: "birthday-grandad-horseracingtv.png" },
  ...
  "birthday-mum-photo1": { title: "Happy Birthday Mum", categories: ["mum", "birthdays", "photo-upload"], preview: "mum-photo1-preview.png", full: "mum-photo1.png",
    photo: { left: 890, top: 500, width: 408.1, height: 340 } },

  "birthday-dad-photo1": { title: "Happy Birthday Dad", categories: ["dad", "birthdays", "photo-upload"], preview: "dad-photo1-preview.png", full: "dad-photo1.png",
    photo: { left: 897, top: 465, width: 440, height: 320 } },
  
  "birthday-handsomehubby": { title: "Handsome Hubby", categories: ["all", "birthdays", "photo-upload"], preview: "handsomehubby-preview.png", full: "handsomehubby.png",
    photo: { left: 890, top: 410, width: 405, height: 405 } },
  
  "birthday-nan-puddles": { title: "Muddy Puddles with Nan", categories: ["all", "nan", "birthdays"], preview: "nan-puddles-preview.png", full: "nan-puddles.png" },
  ...
  "birthday-ladies-lunch": { title: "Ladies That Lunch", categories: ["all", "birthdays"], preview: "ladies-lunch-preview.png", full: "ladies-lunch.png" },
  "birthday-ladies-shopping": { title: "Ladies That Shop", categories: ["all", "birthdays"], preview: "ladies-shopping-preview.png", full: "ladies-shopping.png" },
  "birthday-bttf": { title: "Back to the Future", categories: ["all", "birthdays", "tv-movies"], preview: "birthday-bttf_preview.png", full: "birthday-bttf.png" },
  "birthday-inbetweeners": { title: "The Inbetweeners", categories: ["all", "birthdays", "tv-movies"], preview: "birthday-inbetweeners-preview.png", full: "birthday-inbetweeners.png" },
  ...
  "birthday-wine-girls": { title: "Wine O'Clock", categories: ["all", "birthdays"], preview: "wine-girls-preview.png", full: "wine-girls.png" },
  ...
  "exams-boy": { title: "Exams Congratulations Boy", categories: ["all", "achievements"], preview: "exams-boy-preview.png", full: "exams-boy.png" },
  ...
  "newhome5": { title: "Together Forever", categories: ["all", "home"], preview: "newhome5-preview.png", full: "newhome5.png" },
  "newhome6": { title: "New Home, New Memories", categories: ["all", "home"], preview: "newhome6-preview.png", full: "newhome6.png" },
  "newhome7": { title: "New University Home", categories: ["all", "school-cards", "home"], preview: "newhome7-preview.png", full: "newhome7.png" },
  "newhome8": { title: "New Home, New Dreams", categories: ["all", "home"], preview: "newhome8-preview.png", full: "newhome8.png" },
  "newhome9": { title: "Loveable Home", categories: ["all", "home"], preview: "newhome9-preview.png", full: "newhome9.png" },
  "newhome10": { title: "New Pad", categories: ["all", "home"], preview: "newhome10-preview.png", full: "newhome10.png" },
  ...
  "newbaby-butterflies": { title: "Baby Butterflies", categories: ["all", "newbaby", "photo-upload"], preview: "newbaby-butterflies-preview.png", full: "newbaby-butterflies.png", name: { left: 894, top: 620, startSize: 38, minSize: 34, maxSize: 34, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#ffffff", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 13 },
    photo: { left: 897, top: 405, width: 450, height: 350 } },
  
  "newbaby-itsagirl": { title: "It's a Girl", categories: ["all", "newbaby", "photo-upload"], preview: "newbaby-itsagirl-preview.png", full: "newbaby-itsagirl.png", name: { left: 893, top: 635, startSize: 43, minSize: 28, maxSize: 28, maxSize: 86, fontFamily: "Anton", fontWeight: "normal", color: "#ffffff", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 15 },
    photo: { left: 897, top: 465, width: 450, height: 250 } },
  
  "newbaby-underthesea": { title: "Under the Sea", categories: ["all", "newbaby", "photo-upload"], preview: "newbaby-underthesea-preview.png", full: "newbaby-underthesea.png", name: { left: 889, top: 589, startSize: 37, minSize: 28, maxSize: 28, maxSize: 86, fontFamily: "Anton", fontWeight: "normal", color: "#ffffff", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 12 },
    photo: { left: 895, top: 370, width: 470, height: 340 } },
  
  "newbaby-rainbows": { title: "Baby Rainbows", categories: ["all", "newbaby", "photo-upload"], preview: "newbaby-rainbows-preview.png", full: "newbaby-rainbows.png", name: { left: 895, top: 623, startSize: 38, minSize: 28, maxSize: 28, maxSize: 86, fontFamily: "Anton", fontWeight: "normal", color: "#ffffff", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 13 },
    photo: { left: 894, top: 415, width: 465, height: 325 } },
  
  "newbaby-spacebaby": { title: "Space Teddy", categories: ["all", "newbaby", "photo-upload"], preview: "newbaby-spacebaby-preview.png", full: "newbaby-spacebaby.png", name: { left: 893, top: 623, startSize: 42, minSize: 28, maxSize: 28, maxSize: 86, fontFamily: "Anton", fontWeight: "normal", color: "#2d659a", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 13 },
    photo: { left: 894, top: 413, width: 350, height: 330 } },
  
  "fathers-day-peaky": { title: "Blinding Dad", categories: ["mothersday-fathersday"], preview: "fathers-day-peaky-preview.png", full: "fathers-day-peaky.png" },
  "fathers-day-pub": { title: "The Father's Arms", categories: ["mothersday-fathersday"], preview: "fathers-day-pub-preview.png", full: "fathers-day-pub.png" },
  "fathers-day-sopranos": { title: "Sopranos Dad", categories: ["mothersday-fathersday"], preview: "fathers-day-sopranos-preview.png", full: "fathers-day-sopranos.png" },
  "fathers-day-godfather": { title: "Godfather Dad", categories: ["mothersday-fathersday"], preview: "fathers-day-godfather-preview.png", full: "fathers-day-godfather.png" },
  ...
  "engagement4": { title: "Engagement Ring", categories: ["all", "weddings-engagements"], preview: "engagement4-preview.png", full: "engagement4.png" },
  ...
  "happy-hen-party1": { title: "Hen Girls Party", categories: ["all", "weddings-engagements"], preview: "happy-hen-party1-preview.png", full: "happy-hen-party1.png" },
 ...
 "christmas-naughtyornice": { title: "Santa's Naughty or Nice? (Video Card)", categories: ["christmas"], preview: "santa-video-preview.png", full: "santa-video.png",
    qr: { left: 918, top: 692, width: 145, height: 145, url: "https://images.cockneycards.com/santasmessage-qr.png" } },
...
//SPORTS
  ...
  "afc-ladies-shirt1": { title: "Arsenal Ladies Shirt", categories: ["sports", "football", "wsl", "arsenalw"], preview: "afc-ladies-shirt1-preview.png", full: "afc-ladies-shirt1.png", name: { left: 884, top: 519, startSize: 28, minSize: 20, maxSize: 30, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: true, curveRadius: 150, tiltAngle: 0, label: "Name", maxChars: 7 }, age: { left: 882, top: 577, startSize: 60, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: true, canChangeColor: true, label: "Shirt", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" } },
  "afc-ladies-shirt2": { title: "Arsenal Ladies Shirt", categories: ["sports", "football", "wsl", "arsenalw"], preview: "afc-ladies-shirt2-preview.png", full: "afc-ladies-shirt2.png", name: { left: 884, top: 519, startSize: 28, minSize: 20, maxSize: 30, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: true, curveRadius: 150, tiltAngle: 0, label: "Name", maxChars: 7 }, age: { left: 882, top: 577, startSize: 60, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: true, canChangeColor: true, label: "Shirt", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" } },
  
  "afc-men-shirt1": { title: "Arsenal Shirt", categories: ["sports", "football", "premiership", "arsenal"], preview: "afc-men-shirt1-preview.png", full: "afc-men-shirt1.png", name: { left: 880, top: 492, startSize: 30, minSize: 20, maxSize: 30, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: true, curveRadius: 150, tiltAngle: 0, label: "Name", maxChars: 7 }, age: { left: 880, top: 555, startSize: 70, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: true, canChangeColor: true, label: "Shirt", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" } },
  "afc-men-shirt2": { title: "Arsenal Shirt", categories: ["sports", "football", "premiership", "arsenal"], preview: "afc-men-shirt2-preview.png", full: "afc-men-shirt2.png", name: { left: 882, top: 493, startSize: 30, minSize: 20, maxSize: 30, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: true, curveRadius: 150, tiltAngle: 0, label: "Name", maxChars: 7 }, age: { left: 880, top: 555, startSize: 70, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: true, canChangeColor: true, label: "Shirt", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" } },
  ...
  "city-ladies-celebrating": { title: "City Ladies Celebrating", categories: ["sports", "football", "wsl", "man-cityw"], preview: "city-ladies-celebrating-preview.png", full: "city-ladies-celebrating.png" },
  "spurs-ladies-celebrating": { title: "Spurs Ladies Celebrating", categories: ["sports", "football", "wsl", "tottenhamw"], preview: "spurs-ladies-celebrating-preview.png", full: "spurs-ladies-celebrating.png" },
  "brighton-celebrating": { title: "Brighton Celebrating", categories: ["sports", "football", "wsl", "brightonw"], preview: "brighton-celebrating-preview.png", full: "brighton-celebrating.png" },
  "crystalpw-eagles": { title: "Crystal Palace Eagles", categories: ["sports", "football", "wsl", "crystalpw"], preview: "crystalpw-eagles-preview.png", full: "crystalpw-eagles.png" },
  "charltonw-reds": { title: "Charlton Forever", categories: ["sports", "football", "wsl", "charltonw"], preview: "charltonw-reds-preview.png", full: "charltonw-reds.png" },
  "chelseaw-blues": { title: "Brighton Celebrating", categories: ["sports", "football", "wsl", "chelseaw"], preview: "chelseaw-blues-preview.png", full: "chelseaw-blues.png" },
  
  "cfc-shirt-blues1": { title: "Chelsea Blues Shirt", categories: ["sports", "football", "premiership", "chelsea"], preview: "cfc-shirt-blues1-preview.png", full: "cfc-shirt-blues1.png", name: { left: 885, top: 535, startSize: 30, minSize: 20, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: true, curveRadius: 150, tiltAngle: 0, label: "Name", maxChars: 7 }, age: { left: 885, top: 600, startSize: 70, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: false, canChangeColor: true, label: "Shirt", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" } },
  "cfc-shirt-blues2": { title: "Chelsea Blues Shirt", categories: ["sports", "football", "premiership", "chelsea"], preview: "cfc-shirt-blues2-preview.png", full: "cfc-shirt-blues2.png", name: { left: 885, top: 535, startSize: 30, minSize: 20, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: true, curveRadius: 150, tiltAngle: 0, label: "Name", maxChars: 7 }, age: { left: 885, top: 600, startSize: 70, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#FFFFFF", canChangeSize: false, canChangeColor: true, label: "Shirt", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" } },
  
  "dancing-queen": { title: "Dancing Queen", categories: ["all", "birthdays", "children"], preview: "dancing-queen-preview.png", full: "dancing-queen.png" },
  ...
  "topboy-whu": { title: "West Hams Topboy", categories: ["sports", "football", "championship", "west-ham"], preview: "topboy-whu-preview.png", full: "topboy-whu.png" },


  "topboy-mfc": { title: "Millwalls Topboy", categories: ["sports", "football", "championship", "millwall"], preview: "topboy-mfc-preview.png", full: "topboy-mfc.png" },
  ...
  "liv-ladies-celebrating": { title: "Liverpool Ladies Celebrating Card", categories: ["sports", "football", "wsl", "liverpoolw"], preview: "liv-ladies-celebrating-preview.png", full: "liv-ladies-celebrating.png" },
  ...
  "chelsea-photo": { title: "Chelsea's No.1 Supporter", categories: ["sports", "football", "premiership", "chelsea", "photo-upload"], preview: "chelsea-photo-preview.png", full: "chelsea-photo.png", name: { left: 894, top: 249, startSize: 48, minSize: 34, maxSize: 34, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#00196f", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 10 }, age: { left: 892, top: 664, startSize: 110, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#00196f", canChangeSize: true, canChangeColor: true, label: "Age", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" },
    photo: { left: 895, top: 470, width: 480, height: 385 } },
  "spurs-photo": { title: "Tottenhams No.1 Supporter", categories: ["sports", "football", "premiership", "tottenham", "photo-upload"], preview: "spurs-photo-preview.png", full: "spurs-photo.png", name: { left: 893, top: 244, startSize: 48, minSize: 34, maxSize: 34, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#000b43", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 10 }, age: { left: 890, top: 675, startSize: 110, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#000b43", canChangeSize: true, canChangeColor: true, label: "Age", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" },
    photo: { left: 895, top: 466, width: 477, height: 385 } },
  "liverpool-photo": { title: "Liverpools No.1 Supporter", categories: ["sports", "football", "premiership", "liverpool", "photo-upload"], preview: "liverpool-photo-preview.png", full: "liverpool-photo.png", name: { left: 894, top: 244, startSize: 48, minSize: 34, maxSize: 34, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#c10200", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 10 }, age: { left: 894, top: 654, startSize: 110, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#c10200", canChangeSize: true, canChangeColor: true, label: "Age", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" },
    photo: { left: 895, top: 460, width: 475, height: 365 } },
  "westhamw-photo": { title: "West Ham Womens No.1 Supporter", categories: ["sports", "football", "wsl", "westhamw", "photo-upload"], preview: "whamw-photo-preview.png", full: "whamw-photo.png", name: { left: 893, top: 246, startSize: 48, minSize: 34, maxSize: 34, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#6d152b", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 10 }, age: { left: 887, top: 672, startSize: 110, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#6d152b", canChangeSize: true, canChangeColor: true, label: "Age", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" },
    photo: { left: 895, top: 460, width: 477, height: 370 } },
  "unitedw-photo": { title: "Manchester United Womens No.1 Supporter", categories: ["sports", "football", "wsl", "man-utdw", "photo-upload"], preview: "unitedw-photo-preview.png", full: "unitedw-photo.png", name: { left: 893, top: 245, startSize: 48, minSize: 34, maxSize: 34, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#b30200", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 10 }, age: { left: 890, top: 660, startSize: 110, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#b30200", canChangeSize: true, canChangeColor: true, label: "Age", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" },
    photo: { left: 895, top: 460, width: 480, height: 370 } },
  "lcl-photo": { title: "London City Lionesses No.1 Supporter", categories: ["sports", "football", "wsl", "london-cityw", "photo-upload"], preview: "lcl-photo-preview.png", full: "lcl-photo.png", name: { left: 893, top: 248, startSize: 48, minSize: 34, maxSize: 34, maxSize: 34, fontFamily: "Anton", fontWeight: "normal", color: "#18788e", canChangeSize: false, canChangeColor: false, canMove: false, canRotate: false, isCurved: false, curveRadius: 480, tiltAngle: 0, label: "Name", maxChars: 10 }, age: { left: 891, top: 672, startSize: 110, minSize: 20, maxSize: 120, fontFamily: "Anton", fontWeight: "normal", color: "#18788e", canChangeSize: true, canChangeColor: true, label: "Age", maxChars: 2, numericOnly: true, lettersOnly: false, forceUppercase: false, defaultText: "10" },
    photo: { left: 895, top: 460, width: 480, height: 370 } },
  ...
  "dartsmasterphoto": { title: "Darts Master", categories: ["sports", "darts", "photo-upload"], preview: "dartsmasterphoto-preview.png", full: "dartsmasterphoto.png", 
